    ...
    <>
      <div className="bg-gray-800 rounded-lg mt-5 p-3">
        ...
        <p className="text-gray-300 text-sm">
          The easiest way to introduce yourself on GitHub is by creating a
          README in a repository about you! You can start here:
        </p>
        ...
        <div className="border rounded-lg border-gray-500 p-2 mt-3">
          ...
          <p className="text-sm p-1"> 👋 Hi, I’m @{username}</p>
        ...
        <div className="flex justify-end items-center space-x-3 mt-3">
          ...
          <button className="text-sm text-white bg-green-500 p-2 rounded-lg">
            Continue
          </button>
        </div>
      </div>
      ...
      <div className="bg-gray-800 rounded-lg mt-5 p-5">
        ...
        <p className="text-gray-300 mt-3">
          ...
          you watch or star and people you follow.
        </p>
        <button className="mt-3 px-3 py-1 text-blue-500 bg-gray-900 rounded-lg">
          Explore GitHub
        </button>
      </div>

      <p className="mt-5 text-gray-400 flex text-sm  ">
        <AiOutlineBulb className="h-5 w-5 mr-3" /> ProTip! The feed shows you
        events from people you follow and repositories you watch or star.{" "}
      </p>
      <p className="mt-5 text-gray-400 flex text-sm  ">
        <BsFillRssFill className="h-5 w-5 mr-3" /> Subscribe to your news feed{" "}
      </p>
    </>
  );
};
