...
const [tip, settip] = useState('Mix and match filters to narrow down what you’re looking for.')
  ...
  return (
    ...
    <input type="checkbox" id="my-modal-6" className="modal-toggle  " />
        ...
        <p className="p-3 text-xs text-gray-400 active:bg-gray-700 rounded-md "><label for="my-modal-6" >Private repositories only</label></p>
        <p className="p-3 text-xs text-gray-400 active:bg-gray-700 rounded-md "><label for="my-modal-6" >Public repositories only</label></p>
        </div>
        </div>
        ...
        <div className="modal-action text-white ">
            <label for="my-modal-7" className="btn">Done</label>
        </div>
        </div>
        </div>
        ...
        <ul  className="dropdown-content menu  w-full text-gray-300 text-xs  bg-gray-900 rounded-md border border-gray-800 ">
                ...
                <li className=' w-full  '><p className='space-x-5' ><label for="my-modal-8" className="btn   w-full bg-black py-0 "> Newest</label> </p></li>
                <li className=' w-full  '><p className='space-x-5' ><label for="my-modal-8" className="btn w-full bg-black py-0 ">Oldest</label></p></li>
                <li className=' w-full  '><p className='space-x-5' ><label for="my-modal-8" className="btn w-full bg-black py-0 ">Most commented</label></p></li>
                <li className=' w-full  '><p className='space-x-5' ><label for="my-modal-8" className="btn w-full bg-black py-0 ">Least commented</label></p></li>
                <li className=' w-full  '><p className='space-x-5' ><label for="my-modal-8" className="btn w-full bg-black py-0 ">Recently updated</label></p></li>
                <li className=' w-full  '><p className='space-x-5' ><label for="my-modal-8" className="btn w-full bg-black py-0 ">Last recently updated</label> </p></li>
              </ul>
    ...
    <Header/> 
        <div className=' w-full  p-2 md:p-0 md:w-3/4 mx-auto flex justify-between items-center  ' >
            <div className='flex mt-10  flex-col lg:flex-row items-center justify-around w-full space-y-4 lg:space-y-0 lg:space-x-16 ' >
            <div className=' flex items-center ' >
                <button className='px-3 py-1 border border-gray-700 rounded-l-md focus:bg-blue-500 ' onClick={()=>settip('Mix and match filters to narrow down what you’re looking for.')} >Created</button>
                ...
                <button className='px-3 py-1 border border-gray-700 rounded-r-md  items-center space-x-1 hidden md:inline-flex focus:bg-blue-500' onClick={()=>settip('Mix and match filters to narrow down what you’re looking for.')} > <span>Review</span> <span>requests</span> </button>
            </div>
...
<div className='w-full md:w-3/4  mx-auto flex flex-col border border-gray-600 rounded-md mt-5 p-2 md:p-0' >
...
<div className=' w-full flex flex-col md:flex-row justify-between' >
           ...
           <div class="dropdown  ">
              <label tabindex="0" class="btn m-1 bg-black border-none text-gray-400 focus:text-gray-200 "> Visibility <IoMdArrowDropdown/></label>
              <ul tabindex="0" class="dropdown-content menu   text-gray-300 text-xs  w-72 bg-gray-900 rounded-md border border-gray-800 ">
              ...
              <div class="dropdown">
                  <label tabindex="0" class="btn m-1 bg-black border-none text-gray-400 focus:text-gray-200"> Organisazion <IoMdArrowDropdown/></label>
                  <div tabindex="0" class="dropdown-content card card-compact w-64 p-4 shadow bg-gray-900 text-primary-content  rounded-md border border-gray-800 text-xs ">
                     <div className='flex flex-col space-y-4  '>
                      <div className='w-full flex justify-between'><span>Filter by organization or owner</span></div>
                      <div className='w-full' ><input type="text" placeholder='Filter organizations' className='w-full p-2 border rounded-lg bg-inherit border-gray-800  outline-none' /></div>
                      <div className='flex justify-center items-center space-x-3 hover:bg-gray-800 cursor-pointer p-3 rounded-md transition-all duration-300 ' ><span className='border p-1 rounded-full border-purple-500 ' ><BiUser/></span><span>User123456</span></div>
              ...
              <div class="dropdown  ">
              <label tabindex="0" class="btn m-1 bg-black border-none text-gray-400 focus:text-gray-200 ">Sort  <IoMdArrowDropdown/></label>
              <ul tabindex="0" class="dropdown-content menu   text-gray-300 text-xs  w-72 bg-gray-900 rounded-md border border-gray-800 ">
                <li className='px-5 py-1 ' > <div className='flex justify-between items-center' > <span>Sort by</span> </div> </li>
          ...
          {/* for mobile view */}
           <div className='flex justify-evenly items-center md:hidden '>
            ...
            <label for="my-modal-6" className="btn modal-button text-xs bg-inherit border-none active:bg-black focus:bg-black text-gray-400 ">open modal</label>
            <label for="my-modal-7" className="btn modal-button text-xs bg-inherit border-none active:bg-black focus:bg-black text-gray-400 ">organization</label>
            <label for="my-modal-8" className="btn modal-button text-xs bg-inherit border-none active:bg-black focus:bg-black text-gray-400 ">sort</label>
